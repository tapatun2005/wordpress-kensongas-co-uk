...
$sections[] = array(
	...
	'fields' => array(
		...
		array(
			'id'=>'extra_custom_logo',
			'url'=> true,
			'type' => 'media', 
			'title' => __('Extra logo', 'oneengine'),
			'default' =>'',
			'subtitle' => __('Upload custom extra logo.', 'oneengine'),
		),
...
$sections[] = array(
	...
	'fields' => array(
		...
		array(
			'id'=>'address_general',
			'type' => 'text', 
			'default' => '15 Alexandra Court, James St, York YO10 3DP',
...
$sections[] = array(
	...
	'fields' => array(
		...
		array(
			...
			'type' => 'text', 
			'default' => '0988 11 22 33',
			'title' => __('Type your mobile number', 'oneengine'),
		),
		array(
			'id'=>'email_footer',
			'type' => 'text', 
